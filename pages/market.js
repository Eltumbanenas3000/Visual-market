...
export default function Home() {
    return (
        <>
            ...
            <Link href="/bottles">
                <div className="bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-1 transition-transform transform hover:scale-20 duration-300 text-center cursor-pointer">
            ...
            <Link href="/bottles">
            <div className="bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-1 transition-transform transform hover:scale-20 duration-300 text-center">
           
                    <h3 className="text-3xl font-bold mb-4">Playeras</h3>
                    <div className="flex justify-center space-x-3 mt-7 mb-7">
                    <Image
            ...
            <Link href="/bottles">
                <div className="bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-1 transition-transform transform hover:scale-20 duration-300">
            ...
            <section className="py-16 bg-zinc-900 text-zinc-200">
                ...
                <h2 className="text-center text-3xl font-bold mb-5">Servicios</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
                    <div className="text-center bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-1 transition-transform transform hover:scale-20 duration-600">
                    ...
                    <Image
                        ...
                        descanses y el renombre de tu marca suba como la espuma.</p>
                    </div>
                    <div className="text-center bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-1 transition-transform transform hover:scale-20 duration-600">
                        <Image
                        ...
                        creamos visuales de calidad sin perder la esencia.</p>
                    </div>
                    <div className="text-center bg-zinc-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/100 hover:m-2 transition-transform transform hover:scale-20 duration-600">
                        <Image
                            src="/brandbord.jpg"
                            width={400}
                            height={250}
